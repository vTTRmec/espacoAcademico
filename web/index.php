...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
    ...
    <!-- Parte mural de mensagens, Leonardo! -->
	<div class="w3-twothird">
	      ...
	      <div class="w3-container w3-card w3-white w3-margin-bottom">
	        ...
	        <div class="w3-container">
	          <h5 class="w3-opacity"><b>Passeio - Zoológico</b></h5>
	          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Maio 2018 - <span class="w3-tag w3-teal w3-round">Aberto</span></h6> <!-- STATUS DO ITEM -->
	          <p>Passeio para o zoológico de Brasília.</p>
	          <hr>
	        </div>
		       	 <div class="w3-container w3-card w3-white w3-margin-bottom">
	          ...
	          <img src="img/port.png" class="w3-circle w3-grayscale-max" style="width: 12%;" alt="Norway">

	          <img src="img/math.png" class="w3-circle w3-grayscale-max" style="width: 12%; margin-left: 8%;" alt="Norway"> 

	          <img src="img/hist.png" class="w3-circle w3-grayscale-max" style="width: 12%; margin-left: 8%;" alt="Norway"> 

	          <img src="img/geo.png" class="w3-circle w3-grayscale-max" style="width: 12%; margin-left: 8%;" alt="Norway"> 

	        </div>
	        <h5 class="w3-opacity">
            <!-- PORTUGÊS -->

            <b style="margin-left: 2.2%;">Português <span class="w3-round-xxlarge w3-red">1</span></b>

            <!-- MATEMÁTICA  -->

            <b style="margin-left: 7%;">Matemática <span class="w3-round-xxlarge w3-red">3</span></b>
