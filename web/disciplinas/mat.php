      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-red" style="width:26%">
              <div class="w3-center w3-text-white">26%</div>
            </div>
          </div>    
          <br>
        </div>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <h2 class="w3-text-grey w3-padding-16">
          <img src="../img/math.png" class="w3-circle w3-grayscale-max w3-margin-right w3-xxlarge w3-text-teal" style="width: 10%;" alt="Norway"> Disciplina: Matemática  
