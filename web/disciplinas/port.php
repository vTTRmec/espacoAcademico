...
<link rel="icon" href="../img/port.png" type="image/x-icon" />
<meta charset="UTF-8">
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        <div class="w3-display-container">
          <img src="../img/profPort.png" style="width:100%" alt="Avatar">
          <div class="w3-display-bottomleft w3-container w3-text-ligt-black" style="font-family: Arial, sans-serif;">
            <h2>Professor: Bruno Silva</h2>
          </div>
        </div>
        <div class="w3-container">
          <center><p><i class="fa fa-info fa-fw w3-margin-right w3-large w3-text-teal"></i>Informações sobre o professor</p></center>
          <hr>
          <p><i class="fa fa-mortar-board fa-fw w3-margin-right w3-large w3-text-teal"></i>Formação Academica: Letras - UnB</p>
          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>port.prof@espacocademico.com</p>
          <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i>(61) 3333-4587</p>
          <hr>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container w3-card-4 w3-white w3-margin-bottom">
          ...
          <div class="w3-container" >
            <textarea rows="5" placeholder="Envie uma mensagem para seu Professor" style="width: 100%; resize: none;"> 
            </textarea>
            <br>
            <br>
